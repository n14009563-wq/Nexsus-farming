...
public final class NexusFarmingTest {
    ...
    private static void testGoldenHoeUtil() {
        ...
        checkEquals("damage with no Unbreaking applies every point", damageOf(noUnbreaking), 5);
        ...
        checkEquals("an Unbreakable hoe never takes damage", damageOf(unbreakable), 0);
    ...
    /** Mirrors the real cast GoldenHoeUtil itself has to make -- ItemMeta alone has no getDamage(). */
